...
class MessageDetailPage extends StatefulWidget {
  ...
  MessageDetailPage({required this.rec});
...
class _MessageDetailPageState extends State<MessageDetailPage> {
  ...
  Future<void> _fetchMessages() async {
    print('rec Value: ${widget.rec}');
    final response = await http.get(
      Uri.parse(
          'https://finderastu.pythonanywhere.com/get-person-message/?rec=${widget.rec}'),
      headers: {
  ...
  Future<void> sendMessage(String content) async {
    ...
    print('Response Status Code: ${response.statusCode}');
    print('Response Body: ${response.body}');
    print('Response Body: ${rec}');

    if (response.statusCode == 200) {
      // Message sent successfully
      print('Message sent successfully');
      setState(() {
        _messages.insert(0, '${widget.rec}: $content');
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final isSent = message.startsWith(widget.rec);
                  final alignment =
