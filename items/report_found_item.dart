    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        var request = http.MultipartRequest(
          'POST',
          Uri.parse(
              'http://finderastu.pythonanywhere.com/thread/post-found-item'),
        );
        ...
        if (response.statusCode == 200) {
          showDialog(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                title: Text('Success'),
                content: Text('Found Item report submitted successfully.'),
                actions: <Widget>[
                  TextButton(
                    onPressed: () {
          ...
          showDialog(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                title: Text('Error'),
                content: Text('Failed to submit the Found Item report.'),
                actions: <Widget>[
                  TextButton(
                    onPressed: () {
